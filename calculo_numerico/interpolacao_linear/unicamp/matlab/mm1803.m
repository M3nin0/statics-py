...
%   - x & y: pontos que serão usados para interpolar
%   - xi: é o ponto do qual se deseja saber o valor interpolado
%   - método: método da interpolação (linear, cubic, spline, nearest)

spli = interp1(Hz,spl,Hzi,'spline'); % interpolate near minimum
i = find(Hz>=2e3 & Hz<=5e3); % find original data indices near minimum

figure % Figure para o plot
